...
const styles = StyleSheet.create({
  ...
  searchBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: AppColors.surface, borderRadius: 10, borderWidth: 1, borderColor: AppColors.border, paddingHorizontal: 12 },
  ...
  cardIcon: { width: 38, height: 38, borderRadius: 10, backgroundColor: AppColors.infoSoft, alignItems: 'center', justifyContent: 'center', marginRight: 12 },
