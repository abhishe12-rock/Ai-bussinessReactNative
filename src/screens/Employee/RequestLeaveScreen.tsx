...
const styles = StyleSheet.create({
  ...
  sectionLabel: { color: AppColors.textSecondary, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 10 },
  formCard: {
    backgroundColor: AppColors.surface,
    borderRadius: 12,
    borderWidth: 1,
  ...
  dateBox: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: AppColors.background, borderRadius: 10, borderWidth: 1, borderColor: AppColors.border, padding: 12 },
  dateText: { flex: 1, color: AppColors.textPrimary, fontSize: 13 },
  reasonBox: { backgroundColor: AppColors.background, borderRadius: 10, borderWidth: 1, borderColor: AppColors.border, padding: 12, marginTop: 12 },
  reasonInput: { color: AppColors.textPrimary, fontSize: 13.5, minHeight: 50, textAlignVertical: 'top' },
  submitButton: { backgroundColor: AppColors.primary, borderRadius: 10, height: 46, alignItems: 'center', justifyContent: 'center', marginTop: 14 },
  submitButtonText: { color: '#fff', fontSize: 13.5, fontWeight: '600' },
  ...
  requestMeta: { color: AppColors.textMuted, fontSize: 11.5, marginTop: 5 },
