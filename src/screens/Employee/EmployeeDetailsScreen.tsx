    ...
    <View style={styles.flex}>
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('ManageAccess', { employee })}
          hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}
        >
          <Icon name="admin-panel-settings" color={AppColors.primary} size={20} />
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  tabIndicator: { height: 2.5, backgroundColor: AppColors.primary, marginTop: 8, borderRadius: 1 },
  ...
  sectionLabel: { color: AppColors.textSecondary, fontSize: 11.5, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 8, marginTop: 4 },
  profileCard: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: AppColors.surface,
  ...
  profileImg: { width: 64, height: 64, borderRadius: 18 },
  profileInitials: {
    width: 64,
    height: 64,
    borderRadius: 18,
  ...
  profileInitialsText: { color: AppColors.primary, fontSize: 20, fontWeight: '700' },
  profileName: { color: AppColors.textPrimary, fontSize: 16, fontWeight: '700', letterSpacing: -0.2 },
  profileCode: { color: AppColors.textSecondary, fontSize: 12, marginTop: 3 },
  profilePhotoTag: { color: AppColors.success, fontSize: 11, fontWeight: '600', marginTop: 4 },
  infoCard: {
    backgroundColor: AppColors.surface,
    borderRadius: 12,
    borderWidth: 1,
  ...
  divider: { height: 1, backgroundColor: AppColors.border, marginVertical: 4, marginHorizontal: 14 },
  noticeBox: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: AppColors.infoSoft, borderRadius: 10, borderWidth: 1, borderColor: `${AppColors.info}20`, padding: 12, marginTop: 16 },
  noticeText: { flex: 1, color: AppColors.info, fontSize: 12, fontWeight: '500', lineHeight: 17 },
  monthNav: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  monthLabel: { color: AppColors.textPrimary, fontSize: 14.5, fontWeight: '700' },
  presentBanner: { backgroundColor: AppColors.successSoft, borderRadius: 10, paddingVertical: 10, alignItems: 'center', marginTop: 8 },
  ...
  calendarCell: { width: '13%', aspectRatio: 1, borderRadius: 8, borderWidth: 1, borderColor: AppColors.border, alignItems: 'center', justifyContent: 'center' },
  calendarDay: { fontSize: 12, fontWeight: '700' },
  attendanceRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: AppColors.surface, borderRadius: 10, borderWidth: 1, borderColor: AppColors.border, padding: 12, marginBottom: 8, gap: 8 },
  ...
  leaveType: { color: AppColors.textPrimary, fontSize: 14, fontWeight: '700' },
  leaveDays: { color: AppColors.textSecondary, fontSize: 12, marginTop: 4 },
  leaveDates: { color: AppColors.textMuted, fontSize: 11.5, marginTop: 2 },
  ...
  activityIcon: { width: 32, height: 32, borderRadius: 8, backgroundColor: AppColors.primarySoft, alignItems: 'center', justifyContent: 'center' },
  activityModule: { color: AppColors.textPrimary, fontSize: 13, fontWeight: '700' },
  activityDesc: { color: AppColors.textSecondary, fontSize: 12, marginTop: 2 },
  activityTime: { color: AppColors.textMuted, fontSize: 11, marginTop: 3 },
});