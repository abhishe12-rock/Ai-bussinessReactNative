...
const styles = StyleSheet.create({
  ...
  postLabel: { color: AppColors.textSecondary, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 10 },
  pickerBox: { backgroundColor: AppColors.background, borderRadius: 10, borderWidth: 1, borderColor: AppColors.border, marginBottom: 10 },
  descBox: { backgroundColor: AppColors.background, borderRadius: 10, borderWidth: 1, borderColor: AppColors.border, padding: 12 },
  descInput: { color: AppColors.textPrimary, fontSize: 13.5, minHeight: 68, textAlignVertical: 'top' },
  postButton: { backgroundColor: AppColors.primary, borderRadius: 10, height: 44, alignItems: 'center', justifyContent: 'center', marginTop: 12 },
  postButtonText: { color: '#fff', fontSize: 13.5, fontWeight: '600' },
  historyHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 24, marginBottom: 10 },
  sectionLabel: { color: AppColors.textSecondary, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5 },
  filterPickerBox: { backgroundColor: AppColors.surface, borderRadius: 8, borderWidth: 1, borderColor: AppColors.border },
  ...
  logDesc: { color: AppColors.textSecondary, fontSize: 12.5, marginTop: 3, lineHeight: 17 },
  logTime: { color: AppColors.textMuted, fontSize: 11, marginTop: 5 },
});