...
//       style={{ marginTop: 29 }}  // ← ADD THIS
//     >
//       <Icon name="arrow-back" color={AppColors.textPrimary} size={22} />
//     </TouchableOpacity>
//     <Text style={[styles.headerTitle, { marginTop: 35 }]}>Edit customer</Text>  // ← ADD marginTop: 35
//     <TouchableOpacity 
//       onPress={saving ? undefined : confirmDelete}
//       style={{ marginTop: 35 }}  // ← ADD THIS
//     >
...
export default function EditCustomerScreen() {
  ...
  return (
    <View style={styles.flex}>
      {/* HEADER — Cupertino-style back button, delete on the right */}
      <View style={styles.header}>
        <TouchableOpacity
          onPress={() => navigation.goBack()}
...
const styles = StyleSheet.create({
  ...
  photoCircle: { width: 92, height: 92, borderRadius: 46, backgroundColor: AppColors.primarySoft, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  photoImg: { width: 92, height: 92, borderRadius: 46 },
  initialsText: { color: AppColors.primary, fontSize: 26, fontWeight: '700' },
  editBadge: { position: 'absolute', right: 0, bottom: 0, width: 28, height: 28, borderRadius: 14, backgroundColor: AppColors.primary, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: AppColors.background },
  photoHint: { textAlign: 'center', color: AppColors.textMuted, fontSize: 12, marginTop: 8 },

  sectionLabel: { color: AppColors.textSecondary, fontSize: 12.5, fontWeight: '700', marginBottom: 8, marginTop: 18, textTransform: 'uppercase' },
  card: {
    backgroundColor: AppColors.surface,
    borderRadius: 14,
    borderWidth: 1,
  ...
  fieldInput: { flex: 1, marginLeft: 10, color: AppColors.textPrimary, fontSize: 14, padding: 0 },

  saveButton: {
    flexDirection: 'row', gap: 8,
    backgroundColor: AppColors.primary, borderRadius: 12, height: 50,
  ...
  sheet: { backgroundColor: AppColors.surface, borderTopLeftRadius: 22, borderTopRightRadius: 22, padding: 16, paddingBottom: 28 },
  sheetHandle: { width: 40, height: 4, borderRadius: 4, backgroundColor: AppColors.border, alignSelf: 'center', marginBottom: 16 },
  sheetTitle: { color: AppColors.textPrimary, fontSize: 15, fontWeight: '700', textAlign: 'center', marginBottom: 16 },
  sheetRow: { flexDirection: 'row', gap: 10 },
  photoOption: { flex: 1, alignItems: 'center', paddingVertical: 16, backgroundColor: AppColors.background, borderRadius: 14, borderWidth: 1, borderColor: AppColors.border },
  photoOptionLabel: { color: AppColors.textPrimary, fontSize: 12, fontWeight: '600', marginTop: 6 },
  removeRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, marginTop: 10, paddingVertical: 8 },
  removeText: { color: AppColors.danger, fontSize: 13, fontWeight: '600' },
});