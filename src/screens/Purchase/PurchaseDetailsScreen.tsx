...
const styles = StyleSheet.create({
  ...
  supplierIcon: { width: 38, height: 38, borderRadius: 10, backgroundColor: AppColors.infoSoft, alignItems: 'center', justifyContent: 'center' },
  ...
  receiveButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: AppColors.primary, borderRadius: 12, height: 48, marginTop: 20 },
